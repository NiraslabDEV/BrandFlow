...
// DECISÃO: Stub ZumboPay - implementação completa em fase futura
export class ZumboPayProvider implements PaymentProvider {
  async createCheckout(_input: {
    ...
    throw new Error('ZumboPayProvider not implemented yet');
  }
